  ...
  final List<Map<String, dynamic>> _onboardingData = [
    {
      ...
      'description': 'Engage with our AI chatbot trained in CBT methods to navigate your thoughts and feelings.',
      'icon': Icons.chat_bubble_rounded,
      'color': Colors.teal.shade300,
    },
    {
      'title': 'Insightful Journaling',
      'description': 'Track your mood and uncover patterns with sentiment-aware journaling and analysis.',
      'icon': Icons.book_rounded,
      'color': Colors.blue.shade300,
    },
    {
      'title': 'Personalized For You',
      'description': 'Receive recommendations for music, tasks, and exercises tailored to your mood.',
